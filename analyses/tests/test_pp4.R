...
stopifnot(
  ...
  # Points-only engine: 1 PS + 1 PP = 5 sits at VUS-High, and PP4's +1 is
  # what crosses the Likely Pathogenic threshold at 6.
  classify_acmg(c("PS1","PP1"))$class == "VUS-High",
  classify_acmg(c("PS1","PP1","PP4"))$class == "Likely Pathogenic",
  classify_acmg(c("PS1","PP1","PP4"))$rule == "score 6 pts"
)
