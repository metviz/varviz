...
# 15aa hotspot.
#
# Resumability: per-gene checkpoint files at analyses/ps_tiered/classifications/<gene>__dual.tsv.
...
#   analyses/ps_tiered/classifications/<gene>__dual.tsv  (per-gene checkpoint)
#   analyses/ps_tiered/summary.tsv (concatenated summary)
...
options(varviz.mds_tiered = TRUE)  # tiered MDS: +3 at MDS<=-8
cat("[harness] varviz.mds_tiered = TRUE\n")
...
CHECKPOINT_DIR <- "analyses/ps_tiered/classifications"
SUMMARY_OUT    <- "analyses/ps_tiered/summary.tsv"
